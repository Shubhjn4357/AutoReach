...
export function SkeletonPulse({
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, #171717 25%, #2A2A2A 50%, #171717 75%)",
...
export function CardSkeleton() {
  return (
    ...
    >
      ...
      <SkeletonPulse
        style={{ width: "60%", height: "32px", marginBottom: "8px" }}
      />
  ...
  return (
    <tr style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.05)" }}>
      <td style={{ padding: "20px 0" }}>
        <SkeletonPulse
          style={{ width: "50%", height: "16px", marginBottom: "8px" }}
        />
...
export function DashboardSkeleton() {
  return (
    <div
      style={{ display: "grid", gridTemplateColumns: "3fr 2fr", gap: "30px" }}
    >
      <div
        className="glass-card"
      ...
      >
        ...
        <SkeletonPulse
          style={{ width: "90%", height: "14px", marginBottom: "24px" }}
        />
