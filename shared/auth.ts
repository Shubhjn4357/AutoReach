...
const JWT_SECRET = process.env.JWT_SECRET || "autoreach-production-level-secure-token-key-2026";
...
export function signToken(payload: JWTPayload, expiresInSeconds = 86400 * 30): string {
